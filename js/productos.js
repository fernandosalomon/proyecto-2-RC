...
<div class="card col-12 col-md-6 col-lg-4 p-0 border-0 card-producto  " style="width: 32rem;">
   <a href="../pages/detalleProducto.html?id=${producto.id}">
   <div class="img-container  ">

    <img src="${producto.image}" class="card-img-top  " alt="${producto.title}">
   </div>
  <div class="card-body ">
    <h5 class="card-title  text-dark">${producto.title}</h5>
    <p class="card-category  text-dark ">${producto.category}</p>
    <p class="card-price text-dark ">$${producto.price}</p>
  </div>
   </a>
</div>
